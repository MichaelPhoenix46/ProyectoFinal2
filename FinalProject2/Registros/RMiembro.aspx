        ...
        <div class="form-horizontal col-md-12" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage='El Campo &quot;Cedula&quot; solo acepta numeros' ControlToValidate="CedulaTextBox" ValidationExpression="^[0-9]*$" Text="*" ForeColor="Red" Display="Dynamic" ToolTip="Entrada no valida" ValidationGroup="Guardar"></asp:RegularExpressionValidator>
                    <asp:RequiredFieldValidator ID="ValidadCedula" runat="server" ErrorMessage="El campo &quot;Cedula&quot; esta vacio" ControlToValidate="CedulaTextBox" ForeColor="Red" Display="Dynamic" ToolTip="Campo Cedula obligatorio" ValidationGroup="Guardar">*</asp:RequiredFieldValidator>
                    <br>
                </div>
