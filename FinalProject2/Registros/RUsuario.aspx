...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="panel" style="background-color: black">
        <div class="panel-heading" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: medium; color: #000000; background-color: #2ecc71;">Registro de Usuarios</div>
    </div>
        ...
        <div class="form-horizontal col-md-12" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <asp:RegularExpressionValidator ID="ValidaNombre2" runat="server" ErrorMessage='El Campo &quot;Nombre&quot; solo acepta letras' ControlToValidate="NombreTextBox" ValidationExpression="^[A-Za-z]*$" Text="*" ForeColor="Red" Display="Dynamic" ToolTip="Entrada no valida" ValidationGroup="Guardar"></asp:RegularExpressionValidator>
                </div>
